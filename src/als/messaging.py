...
class MessageHub(QObject):
    ...
    def dispatch_info(self, name: str, message: str, values: list = None):
        ...
        self._dispatch_message(AlsLogAdapter(getLogger(__name__), {}).info, "INFO", message, values)
    ...
    def dispatch_warning(self, name: str, message: str, values: list = None):
        ...
        self._dispatch_message(AlsLogAdapter(getLogger(__name__), {}).warning, "WARNING", message, values)
    ...
    def dispatch_error(self, name: str, message: str, values: list = None):
        ...
        self._dispatch_message(AlsLogAdapter(getLogger(__name__), {}).error, "ERROR", message, values)
