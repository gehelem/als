...
class Ui_stack_window(object):
    def setupUi(self, stack_window):
        ...
        self.black_slider.setMaximum(65525)
        ...
        self.white_slider.setMaximum(65525)
        self.white_slider.setSliderPosition(65525)
    ...
    def retranslateUi(self, stack_window):
        ...
        self.white.setText(_translate("stack_window", "65525"))
