...
class Ui_stack_window(object):
    def setupUi(self, stack_window):
        ...
        self.tFolder.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.verticalSlider_4.setMaximum(200)
        ...
        self.verticalSlider_5.setMaximum(200)
        ...
        self.verticalLayout.addWidget(self.postprocess_widget)
