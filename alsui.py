...
class Ui_stack_window(object):
    def setupUi(self, stack_window):
        ...
        self.groupWork = QtWidgets.QGroupBox(self.centralwidget)
        self.groupWork.setObjectName("groupWork")
        self.layoutWidget = QtWidgets.QWidget(self.groupWork)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 521, 31))
        self.layoutWidget.setObjectName("layoutWidget")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.layoutWidget)
        self.gridLayout_5.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.tWork = QtWidgets.QLineEdit(self.layoutWidget)
        self.tWork.setEnabled(False)
        self.tWork.setObjectName("tWork")
        self.gridLayout_5.addWidget(self.tWork, 0, 1, 1, 1)
        self.bBrowseWork = QtWidgets.QPushButton(self.layoutWidget)
        self.bBrowseWork.setObjectName("bBrowseWork")
        self.gridLayout_5.addWidget(self.bBrowseWork, 0, 2, 1, 1)
        self.verticalLayout.addWidget(self.groupWork)
    ...
    def retranslateUi(self, stack_window):
        ...
        self.groupWork.setTitle(_translate("stack_window", "GroupBox"))
