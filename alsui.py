...
class Ui_stack_window(object):
    def setupUi(self, stack_window):
        ...
        self.wvlt_level_1 = QtWidgets.QSlider(self.centralwidget)
        self.wvlt_level_1.setEnabled(False)
        self.wvlt_level_1.setMinimumSize(QtCore.QSize(250, 0))
        self.wvlt_level_1.setMaximumSize(QtCore.QSize(16777215, 20))
        self.wvlt_level_1.setMaximum(100)
        self.wvlt_level_1.setOrientation(QtCore.Qt.Horizontal)
        self.wvlt_level_1.setObjectName("wvlt_level_1")
        self.horizontalLayout_16.addWidget(self.wvlt_level_1)
        ...
        self.wvlt_level_2 = QtWidgets.QSlider(self.centralwidget)
        self.wvlt_level_2.setMaximum(100)
        self.wvlt_level_2.setOrientation(QtCore.Qt.Horizontal)
        self.wvlt_level_2.setObjectName("wvlt_level_2")
        self.horizontalLayout_17.addWidget(self.wvlt_level_2)
        ...
        self.wvlt_level_3 = QtWidgets.QSlider(self.centralwidget)
        self.wvlt_level_3.setMaximum(100)
        self.wvlt_level_3.setOrientation(QtCore.Qt.Horizontal)
        self.wvlt_level_3.setObjectName("wvlt_level_3")
        self.horizontalLayout_18.addWidget(self.wvlt_level_3)
        ...
        self.wvlt_level_4 = QtWidgets.QSlider(self.centralwidget)
        self.wvlt_level_4.setMaximum(100)
        self.wvlt_level_4.setOrientation(QtCore.Qt.Horizontal)
        self.wvlt_level_4.setObjectName("wvlt_level_4")
        self.horizontalLayout_15.addWidget(self.wvlt_level_4)
        ...
        self.wvlt_level_5 = QtWidgets.QSlider(self.centralwidget)
        self.wvlt_level_5.setMaximum(100)
        self.wvlt_level_5.setOrientation(QtCore.Qt.Horizontal)
        self.wvlt_level_5.setObjectName("wvlt_level_5")
        self.horizontalLayout_10.addWidget(self.wvlt_level_5)
        ...
        self.wvlt_level_1.valueChanged['int'].connect(self.label_17.setNum)
        self.wvlt_level_2.valueChanged['int'].connect(self.label_18.setNum)
        self.wvlt_level_3.valueChanged['int'].connect(self.label_19.setNum)
        self.wvlt_level_4.valueChanged['int'].connect(self.label_20.setNum)
        self.wvlt_level_5.valueChanged['int'].connect(self.label_21.setNum)
    ...
    def retranslateUi(self, stack_window):
        ...
        self.label_17.setText(_translate("stack_window", "0"))
        self.label_14.setText(_translate("stack_window", "Level 2:"))
        self.label_18.setText(_translate("stack_window", "0"))
        self.label_13.setText(_translate("stack_window", "Level 3:"))
        self.label_19.setText(_translate("stack_window", "0"))
        self.label_16.setText(_translate("stack_window", "Level 4:"))
        self.label_20.setText(_translate("stack_window", "0"))
        self.label_12.setText(_translate("stack_window", "Level 5:"))
        self.label_21.setText(_translate("stack_window", "0"))
